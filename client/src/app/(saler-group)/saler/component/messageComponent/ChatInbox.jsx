...
export default function ChatInbox({ setChatIsOpen }) {
    return (
        < >
            ...
            <header className="sticky w-full border-2 top-0 py-4  h-20 bg-white border-b border-slate-200 px-6  shadow-sm " >
                ...
                <div className='flex gap-4 items-center ' >
                    <span
                        ...
                        className='text-[24px] font-bold lg:hidden block ' >
                        <AiOutlineArrowLeft />
                    </span>
            ...
            <div className="sticky w-full  sm:bottom-0 bottom-[55px] py-4  h-20 bg-white
             border-y border-slate-200 md:px-6 px-2  shadow-sm " suppressHydrationWarning >
                ...
                ' suppressHydrationWarning>
                    <div className="md:w-[95%] w-[80%] h-full ">
                        <input type="text" placeholder="Search clients, properties..." className="w-full h-full pl-10 pr-4 py-2 bg-slate-100 border border-transparent rounded-lg text-sm focus:bg-white focus:border-blue-500 focus:outline-none transition" />
                    </div>

                    <div className=' h-[50px] w-[50px] rounded-full bg-[blue] text-white flex items-center justify-center ' >
                        <IoSend />
                    </div>
            ...
            <div className="flex items-end gap-3 max-w-xl">
                <div className='flex flex-col gap-2' >
                    <div className="bg-white p-4 rounded-2xl rounded-bl-none border border-slate-100 shadow-sm">
                        <p className="text-sm text-slate-800 leading-relaxed">Hello! I just finished browsing through the property prospectus. Is the parking space included in the current listing lease terms?</p>
                    </div>
                    <div className="text-[10px] text-slate-400 font-medium">10:14 AM</div>
                </div>
            </div>
        </>
    )
