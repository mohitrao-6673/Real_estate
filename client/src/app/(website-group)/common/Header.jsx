...
import { logout, saveUser } from '@/app/slices/userSlice';
...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* header for desktop */}
      <header className={`fixed top-0 w-full z-2 md:block hidden px-4  py-2 duration-300
       ${isScrolled ? 'bg-white py-4 text-black shadow-2xl  ' : 'text-white'}
        `} >
      ...
      <header className={`fixed top-0 w-full z-2 md:hidden block px-4  py-2 duration-300
       ${isScrolled ? 'bg-white py-3 text-black shadow-2xl  ' : 'text-white'}
        `}  >
